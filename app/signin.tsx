...
export default function DashboardScreen() {
  ...
  const [webViewUrl, setWebViewUrl] = useState<string>('https://dapper-maamoul-a788b2.netlify.app/'); // default web app
  ...
  (async () => {
    ...
    subscription = await Location.watchPositionAsync(
      ...
      (loc) => {
        ...
        const url = `https://dapper-maamoul-a788b2.netlify.app/?lat=${latitude}&lng=${longitude}`;
        setWebViewUrl(url);
      }
    );
  })();
    ...
    <>
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.footer}>
          <TouchableOpacity style={[styles.tab, styles.activeTab]} onPress={() => setWebViewUrl('https://dapper-maamoul-a788b2.netlify.app/`')}>
