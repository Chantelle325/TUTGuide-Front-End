      ...
      <View style={[styles.header, darkMode && styles.darkHeader]}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={[styles.headerSubtitle, darkMode && styles.darkText]}>Manage your app</Text>
          </View>
        </View>
        <TouchableOpacity
            ...
            <View style={{ marginVertical: 20 }}>
              ...
              <LineChart
                data={{
                  ...
                  datasets: [{ data: [totalUsers, previousUsers, totalBuildings, totalRooms], color: () => darkMode ? "#FFA500" : "#4CAF50", strokeWidth: 2 }],
                }}
              ...
              return (
                <View key={idx} style={styles.locationCard}>
                  <View style={styles.locationHeader}>
                    <Text style={[styles.locationName, isViewed && styles.viewedFeedbackText, darkMode && styles.darkText]}>
          ...
          <View style={styles.tabContent}>
            ...
            <View style={styles.settingsGrid}>
              <TouchableOpacity style={styles.settingsCard} onPress={() => router.push("/admin-profile")}>
                ...
                <Text style={styles.settingsCardDesc}>Update your profile details and credentials</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.settingsCard} onPress={() => router.push("/manage-users")}>
              ...
              <TouchableOpacity style={styles.settingsCard} onPress={() => router.push("/system-preferences")}>
                <Text style={styles.settingsCardTitle}>System Preferences</Text>
                <Text style={styles.settingsCardDesc}>Configure system settings and preferences</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  logoutButton: { padding: 10, borderRadius: 50, backgroundColor: "#fff", borderWidth: 1, borderColor: "#fff" },
  ...
  dashboardCard: { backgroundColor: "#fff", width: "43%", borderRadius: 12, padding: 15, alignItems: "center", justifyContent: "center", shadowColor: "#000", shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 3, marginLeft: 10, marginRight: 8 },
